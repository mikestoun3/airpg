      ...
      <div className="w-full md:w-72 md:flex-shrink-0 flex flex-col gap-4 md:overflow-y-auto md:pb-2">
        ...
        <div className="flex-shrink-0 bg-[#16161f] border border-[rgba(255,255,255,0.09)] rounded-xl overflow-hidden">
          <div className="relative h-36 md:h-40 overflow-hidden bg-[#0e0e14]">
            <img src={character.gender === 'female' ? '/icons/character_portrait_female.png' : '/icons/character_avatar.png'} alt="portrait"
        ...
        <div className="bg-[#16161f] border border-[rgba(255,255,255,0.09)] rounded-xl p-5">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <div key={label} className="bg-[#111118] rounded-xl p-3 md:p-4 text-center">
                <p className="text-xl md:text-2xl mb-1">{icon}</p>
                <p className="text-slate-100 font-bold text-xl md:text-2xl">{value}</p>
                <p className="text-[#505058] text-[10px] md:text-[11px] mt-1">{label}</p>
              </div>
            ))}
          </div>
        </div>
