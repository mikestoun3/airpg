      ...
      <div className="w-56 flex-shrink-0 flex flex-col gap-4">
        ...
        <div className="space-y-1.5">
          {RESOURCES.map((res) => {
            ...
            const rarityColor =
              res.rarity === 'rare' ? '#60a5fa' :
              res.rarity === 'uncommon' ? '#4ade80' : '#9ca3af';
            return (
              <div key={res.id}
                ...
                <span className={`font-bold text-sm ${qty > 0 ? 'text-slate-100' : 'text-[#4040a0]'}`}>
                  {qty}
                </span>
              </div>
            );
                ...
                <div className="p-4 flex flex-col gap-3 flex-1">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-0.5">
                      ...
                      <span className="text-[10px] text-[#5050a0] bg-[#0f0f22] px-1.5 py-0.5 rounded">
                        {recipe.slot}
                      </span>
                    </div>
