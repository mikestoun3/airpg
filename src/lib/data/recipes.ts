...
const T1: CraftRecipe[] = [
  {
    ...
    goldCost: 100,
    ingredients: [
      { resourceId: 'iron_ore',      name: 'Ferrite Slab',      quantity: 6 },
      { resourceId: 'rough_leather', name: 'Salvaged Hide', quantity: 3 },
    ],
  ...
  },
  {
    ...
    goldCost: 100,
    ingredients: [
      { resourceId: 'iron_ore',      name: 'Ferrite Slab',      quantity: 5 },
      { resourceId: 'rough_leather', name: 'Salvaged Hide', quantity: 2 },
    ],
  ...
  },
  {
    ...
    goldCost: 100,
    ingredients: [
      { resourceId: 'iron_ore',      name: 'Ferrite Slab',      quantity: 7 },
      { resourceId: 'rough_leather', name: 'Salvaged Hide', quantity: 4 },
    ],
  ...
  },
  {
    ...
    goldCost: 100,
    ingredients: [
      { resourceId: 'rough_leather', name: 'Salvaged Hide', quantity: 5 },
      { resourceId: 'iron_ore',      name: 'Ferrite Slab',      quantity: 3 },
    ],
  ...
  },
  {
    ...
    goldCost: 100,
    ingredients: [
      { resourceId: 'arcane_dust',   name: 'Phase Dust',   quantity: 5 },
      { resourceId: 'iron_ore',      name: 'Ferrite Slab',      quantity: 2 },
    ],
  ...
  },
  {
    ...
    ingredients: [
      { resourceId: 'rough_leather', name: 'Salvaged Hide', quantity: 4 },
      { resourceId: 'arcane_dust',   name: 'Phase Dust',   quantity: 3 },
    ],
...
const T2: CraftRecipe[] = [
  {
    ...
    goldCost: 300,
    ingredients: [
      { resourceId: 'quality_ore',   name: 'Aurite Ore',   quantity: 5 },
      { resourceId: 'spirit_thread', name: 'Null Weave', quantity: 2 },
    ],
  ...
  },
  {
    ...
    goldCost: 300,
    ingredients: [
      { resourceId: 'quality_ore',   name: 'Aurite Ore',   quantity: 4 },
      { resourceId: 'rough_leather', name: 'Salvaged Hide', quantity: 3 },
    ],
  ...
  },
  {
    ...
    goldCost: 300,
    ingredients: [
      { resourceId: 'quality_ore',   name: 'Aurite Ore',   quantity: 6 },
      { resourceId: 'spirit_thread', name: 'Null Weave', quantity: 3 },
    ],
  ...
  },
  {
    ...
    goldCost: 300,
    ingredients: [
      { resourceId: 'quality_ore',   name: 'Aurite Ore',   quantity: 3 },
      { resourceId: 'spirit_thread', name: 'Null Weave', quantity: 3 },
    ],
  ...
  },
  {
    ...
    goldCost: 300,
    ingredients: [
      { resourceId: 'spirit_thread', name: 'Null Weave', quantity: 4 },
      { resourceId: 'arcane_dust',   name: 'Phase Dust',   quantity: 4 },
    ],
...
const T3: CraftRecipe[] = [
  {
    ...
    goldCost: 700,
    ingredients: [
      { resourceId: 'mithril_shard', name: 'Echo Shard', quantity: 6 },
      { resourceId: 'quality_ore',   name: 'Aurite Ore',   quantity: 4 },
    ],
  ...
  },
  {
    ...
    goldCost: 700,
    ingredients: [
      { resourceId: 'mithril_shard', name: 'Echo Shard', quantity: 5 },
      { resourceId: 'spirit_thread', name: 'Null Weave', quantity: 4 },
    ],
  ...
  },
  {
    ...
    goldCost: 700,
    ingredients: [
      { resourceId: 'mithril_shard', name: 'Echo Shard', quantity: 8 },
      { resourceId: 'quality_ore',   name: 'Aurite Ore',   quantity: 5 },
    ],
  ...
  },
  {
    ...
    ingredients: [
      { resourceId: 'mithril_shard', name: 'Echo Shard', quantity: 5 },
      { resourceId: 'spirit_thread', name: 'Null Weave', quantity: 5 },
    ],
  ...
  },
  {
    ...
    goldCost: 700,
    ingredients: [
      { resourceId: 'mithril_shard', name: 'Echo Shard', quantity: 4 },
      { resourceId: 'arcane_dust',   name: 'Phase Dust',   quantity: 6 },
    ],
  ...
  },
  {
    ...
    ingredients: [
      { resourceId: 'mithril_shard', name: 'Echo Shard', quantity: 4 },
      { resourceId: 'spirit_thread', name: 'Null Weave', quantity: 6 },
    ],
...
const T4: CraftRecipe[] = [
  {
    ...
    goldCost: 1500,
    ingredients: [
      { resourceId: 'void_shard',    name: 'Nexus Core',    quantity: 8 },
      { resourceId: 'mithril_shard', name: 'Echo Shard', quantity: 5 },
    ],
  ...
  },
  {
    ...
    goldCost: 1500,
    ingredients: [
      { resourceId: 'void_shard',    name: 'Nexus Core',    quantity: 7 },
      { resourceId: 'mithril_shard', name: 'Echo Shard', quantity: 4 },
    ],
  ...
  },
  {
    ...
    goldCost: 1500,
    ingredients: [
      { resourceId: 'void_shard',    name: 'Nexus Core',    quantity: 10 },
      { resourceId: 'mithril_shard', name: 'Echo Shard', quantity: 6 },
    ],
  ...
  },
  {
    ...
    goldCost: 1500,
    ingredients: [
      { resourceId: 'void_shard',    name: 'Nexus Core',    quantity: 6 },
      { resourceId: 'arcane_dust',   name: 'Phase Dust',   quantity: 8 },
    ],
  ...
  },
  {
    ...
    ingredients: [
      { resourceId: 'void_shard',    name: 'Nexus Core',    quantity: 6 },
      { resourceId: 'spirit_thread', name: 'Null Weave', quantity: 8 },
    ],
...
export const CONVERSION_RECIPES: ConversionRecipe[] = [
  { id: 'convert_iron_to_quality',    fromResourceId: 'iron_ore',      fromName: 'Ferrite Slab',      fromQuantity: 3, toResourceId: 'quality_ore',    toName: 'Aurite Ore',   toQuantity: 1, fromIcon: '🪨', toIcon: '💎' },
  { id: 'convert_quality_to_mithril', fromResourceId: 'quality_ore',   fromName: 'Aurite Ore',   fromQuantity: 3, toResourceId: 'mithril_shard',  toName: 'Echo Shard', toQuantity: 1, fromIcon: '💎', toIcon: '✨' },
  { id: 'convert_leather_to_thread',  fromResourceId: 'rough_leather', fromName: 'Salvaged Hide', fromQuantity: 3, toResourceId: 'spirit_thread',  toName: 'Null Weave', toQuantity: 1, fromIcon: '🧵', toIcon: '🌿' },
  { id: 'convert_thread_to_void',     fromResourceId: 'spirit_thread', fromName: 'Null Weave', fromQuantity: 3, toResourceId: 'void_shard',     toName: 'Nexus Core',    toQuantity: 1, fromIcon: '🌿', toIcon: '🌑' },
  { id: 'convert_dust_to_thread',     fromResourceId: 'arcane_dust',   fromName: 'Phase Dust',   fromQuantity: 3, toResourceId: 'spirit_thread',  toName: 'Null Weave', toQuantity: 1, fromIcon: '✨', toIcon: '🌿' },
];
